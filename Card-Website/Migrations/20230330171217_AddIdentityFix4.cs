...
{
    /// <inheritdoc />
    public partial class AddIdentityFix4 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImageLinks_SimplePosts_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SimplePostTag", x => new { x.PostsPostId, x.TagsTagId });
                    table.ForeignKey(
